...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE) -> int:
    ...
    await update.message.reply_text("Start handler, Choose a route",
...
async def start_over(update: Update,
    ...
    # interactive menu.
    await query.edit_message_text(text="Start handler, Choose a route",
                                  reply_markup=reply_markup)
    return START_ROUTES
...
def main() -> None:
    ...
    application = Application.builder().token(
        "1973416217:AAFxduyEQwe3eowCALdMkZvV6lH4Ho9uoWA").build()
